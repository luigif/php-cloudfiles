...
use Rackspace\Exception\NonEmptyContainerException;
 ...
 * # validated Authentication instance.
 * #
...
class Connection
{
    ...
    /**
     * Pass in a previously authenticated Authentication instance.
     *
     * Example:
     * <code>
     * # Create the authentication instance
     ...
     *
     * @param obj $cfs_auth previously authenticated Authentication instance
